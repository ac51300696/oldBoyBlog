<template>
    <VueMarkdown id="render-editor" :lang-prefix='"hljs"' :source='this.$store.state.rawHtml' class='markdown-body'>
# h1 Heading 8-)
...
import VueMarkdown from 'vue-markdown'
    export default {
        data() {
            return {
                renderHtml: this.$store.state.renderHtml
            }
        },
        components: {
            VueMarkdown
...
<style>
@import url(https://unpkg.com/katex@0.7.1/dist/katex.min.css);
    #render-editor {
        float:right;
        width:50%;
        height:400px;
